Feature: GM Journey for Linen framework -> See Linen schema from https://miro.com/app/board/o9J_kuCrpYQ=/ design link
  ...
  @linenProduct11 @Regression @LinenFinalTest
  Scenario Outline: To verify Buyer has initiated GM journey for framework "<framework>" and is provided with GM Escape page on selection of Product during the journey
    ...
    And User is displayed with "<service>" answer for the question "What type of cleanroom do you need?"
    ...
    Examples:
      | ScenarioID | framework | service | lookingFor |
      | Scenario 1 | cleanroom | Linen   | Product    |

  @linenProduct2 @Regression @LinenFinalTest
  Scenario Outline: To verify Buyer has initiated GM journey for framework "<framework>" and is provided with GM Escape page on selection of Product during the journey
    Given User logs in to the CCS application for "<ScenarioID>"
    When User enters "<framework>" details
    And User clicks on the "Start now" button
    ...
    Examples:
      | ScenarioID | framework | lookingFor | service | lookingFor2 | budgetRadio | contractRadio | serviceArea            | addFacilities | frameworkId | expirationDate | details    |
      | Scenario 1 | cleanroom | Product    | Linen   | Service     | No          | No            | Theatre pack and gowns | Anything else | RM3830      | 09/07/2022     | fmmDetails |

    #budget: < 1 mil , months: <12, addFacilities: answer No
  @linenService1 @LinenTest @Regression @LinenFinalTest
  Scenario Outline: To verify Buyer has provided with different recommendations "<recommendation>" and after answering different set of question as looking for "<lookingFor>", Budget radio as "<budgetRadio>" and enters budget as "<enterBudgets>", Contract radio as "<contractRadio>" and enters contract length "<contractLength>" , selects Service area as "<serviceArea>" and Additional facilities as "<addFacilities>" during the journey
    ...
    Examples:
      ...
      | Scenario 1 | laundry          | Service    | Yes         | 12345        | Yes           | 10             | Theatre pack and gowns        | No, I have everything I need | RM6154      | 19/03/2023     | linenDetails | lot2           | 1    |
      | Scenario 2 | laundry services | Service    | Yes         | 12345        | Yes           | 11             | Cleanroom services            | No, I have everything I need | RM6154      | 19/03/2023     | linenDetails | lot3           | 1    |
      | Scenario 3 | linen            | Service    | Yes         | 12345        | Yes           | 11             | Linen hire with standard wash | No, I have everything I need | RM6154      | 19/03/2023     | linenDetails | lot1a          | 1    |
      | Scenario 4 | linen hire       | Service    | Yes         | 12345        | Yes           | 7              | Standard wash                 | No, I have everything I need | RM6154      | 19/03/2023     | linenDetails | lot1b          | 1    |

    #budget: < 1 mil , months: <12, addFacilities: answer Other, Security, Grounds maintenance, Catering, Pest Control
  @linenService2 @Regression @LinenFinalTest
  Scenario Outline: To verify Buyer has provided with different recommendations "<recommendation>" and after answering different set of question as looking for "<lookingFor>", Budget radio as "<budgetRadio>" and enters budget as "<enterBudgets>", Contract radio as "<contractRadio>" and enters contract length "<contractLength>" , selects Service area as "<serviceArea>" and Additional facilities as "<addFacilities>" during the journey
    Given User logs in to the CCS application for "<ScenarioID>"
    When User enters "<framework>" details
    And User clicks on the "Start now" button
    ...
    Examples:
      ...
      | Scenario 1 | reusable theatre packs | Service    | Yes         | 12345        | Yes           | 8              | Theatre pack and gowns        | Anything else | RM3830      | 09/07/2022     | fmmDetails |
#      | Scenario 1.1 | linen     | Service    | Yes         | 12345        | Yes           | 10             | Theatre pack and gowns        | Security            | RM3830      | 09/07/2022     | fmmDetails |
...
#      | Scenario 1.4 | linen     | Service    | Yes         | 12345        | Yes           | 6              | Theatre pack and gowns        | Pest control        | RM3830      | 09/07/2022     | fmmDetails |
      | Scenario 2 | wash                   | Service    | Yes         | 12345        | Yes           | 5              | Cleanroom services            | Anything else | RM3830      | 09/07/2022     | fmmDetails |
...
#      | Scenario 2.4 | linen     | Service    | Yes         | 12345        | Yes           | 4              | Cleanroom services            | Pest control        | RM3830      | 09/07/2022     | fmmDetails |
      | Scenario 3 | bath                   | Service    | Yes         | 12345        | Yes           | 5              | Linen hire with standard wash | Anything else | RM3830      | 09/07/2022     | fmmDetails |
...
#      | Scenario 3.4 | linen     | Service    | Yes         | 12345        | Yes           | 4              | Linen hire with standard wash | Pest control        | RM3830      | 09/07/2022     | fmmDetails |
      | Scenario 4 | bed                    | Service    | Yes         | 12345        | Yes           | 5              | Standard wash                 | Anything else | RM3830      | 09/07/2022     | fmmDetails |
...
#      | Scenario 4.4 | linen     | Service    | Yes         | 12345        | Yes           | 4              | Standard wash                 | Pest control        | RM3830      | 09/07/2022     | fmmDetails |
  ...
  @linenService3 @Regression @LinenFinalTest
  Scenario Outline: To verify Buyer has provided with different recommendations "<recommendation>" and after answering different set of question as looking for "<lookingFor>", Budget radio as "<budgetRadio>" and enters budget as "<enterBudgets>", selects Service area as "<serviceArea>" and Additional facilities as "<addFacilities>" during the journey
    ...
    Examples:
      ...
      | Scenario 1 | bedding      | Service    | Yes         | 12345000     | Theatre pack and gowns        | No, I have everything I need | RM6154      | 19/03/2023     | linenDetails | lot2           | 1    |
      | Scenario 2 | globe locums | Service    | Yes         | 12345000     | Cleanroom services            | No, I have everything I need | RM6154      | 19/03/2023     | linenDetails | lot3           | 1    |
      | Scenario 3 | gloves       | Service    | Yes         | 12345000     | Linen hire with standard wash | No, I have everything I need | RM6154      | 19/03/2023     | linenDetails | lot1a          | 1    |
      | Scenario 4 | gowns        | Service    | Yes         | 12345000     | Standard wash                 | No, I have everything I need | RM6154      | 19/03/2023     | linenDetails | lot1b          | 1    |

    #budget: > 1 mil, addFacilities: answer Other, Security, Grounds maintenance, Catering, Pest Control
  @linenService4 @Regression @LinenFinalTest
  Scenario Outline: To verify Buyer has provided with different recommendations "<recommendation>" and after answering different set of question as looking for "<lookingFor>", Budget radio as "<budgetRadio>" and enters budget as "<enterBudgets>", selects Service area as "<serviceArea>" and Additional facilities as "<addFacilities>" during the journey
    Given User logs in to the CCS application for "<ScenarioID>"
    When User enters "<framework>" details
    And User clicks on the "Start now" button
    ...
    Examples:
      ...
      | Scenario 1 | hire      | Service    | Yes         | 12345000     | Theatre pack and gowns        | Anything else | RM3830      | 09/07/2022     | fmmDetails |
...
#      | Scenario 1.4 | linen     | Service    | Yes         | 12345000     | Theatre pack and gowns        | Pest control        | RM3830      | 09/07/2022     | fmmDetails |
      | Scenario 2 | laundry   | Service    | Yes         | 12345000     | Cleanroom services            | Anything else | RM3830      | 09/07/2022     | fmmDetails |
...
#      | Scenario 3.4 | linen     | Service    | Yes         | 12345000     | Linen hire with standard wash | Pest control        | RM3830      | 09/07/2022     | fmmDetails |
      | Scenario 4 | linen     | Service    | Yes         | 12345000     | Standard wash                 | Anything else | RM3830      | 09/07/2022     | fmmDetails |
...
#      | Scenario 4.4 | linen     | Service    | Yes         | 12345000     | Standard wash                 | Pest control        | RM3830      | 09/07/2022     | fmmDetails |
    ...
    #budget: < 1 mil , months: >12, addFacilities: answer No
  @linenService5 @Regression @LinenFinalTest
  Scenario Outline: To verify Buyer has provided with different recommendations "<recommendation>" and after answering different set of question as looking for "<lookingFor>", Budget radio as "<budgetRadio>" and enters budget as "<enterBudgets>", Contract radio as "<contractRadio>" and enters contract length "<contractLength>" , selects Service area as "<serviceArea>" and Additional facilities as "<addFacilities>" during the journey
    Given User logs in to the CCS application for "<ScenarioID>"
    When User enters "<framework>" details
    And User clicks on the "Start now" button
    ...
    Examples:
      | ScenarioID | framework         | lookingFor | budgetRadio | enterBudgets | contractRadio | contractLength | serviceArea                   | addFacilities                | frameworkId | expirationDate | details      | recommendation | lots |
      | Scenario 1 | Linen and Laundry | Service    | Yes         | 12345        | Yes           | 13             | Theatre pack and gowns        | No, I have everything I need | RM6154      | 19/03/2023     | linenDetails | lot2           | 1    |
      | Scenario 2 | specialist        | Service    | Yes         | 12345        | Yes           | 14             | Cleanroom services            | No, I have everything I need | RM6154      | 19/03/2023     | linenDetails | lot3           | 1    |
      | Scenario 3 | waste disposal    | Service    | Yes         | 12345        | Yes           | 21             | Linen hire with standard wash | No, I have everything I need | RM6154      | 19/03/2023     | linenDetails | lot1a          | 1    |
      | Scenario 4 | laund             | Service    | Yes         | 12345        | Yes           | 30             | Standard wash                 | No, I have everything I need | RM6154      | 19/03/2023     | linenDetails | lot1b          | 1    |

    #budget: < 1 mil , months: >12, addFacilities: answer Other, Security, Grounds maintenance, Catering, Pest Control
  @linenService6 @Regression @LinenFinalTest
  Scenario Outline: To verify Buyer has provided with different recommendations "<recommendation>" and after answering different set of question as looking for "<lookingFor>", Budget radio as "<budgetRadio>" and enters budget as "<enterBudgets>", Contract radio as "<contractRadio>" and enters contract length "<contractLength>" , selects Service area as "<serviceArea>" and Additional facilities as "<addFacilities>" during the journey
    Given User logs in to the CCS application for "<ScenarioID>"
    When User enters "<framework>" details
    And User clicks on the "Start now" button
...
#      | Scenario 1.4 | linen     | Service    | Yes         | 12345        | Yes           | 16             | Theatre pack and gowns        | Pest control        | RM3830      | 09/07/2022     | fmmDetails |
      | Scenario 2 | laundry and linen | Service    | Yes         | 12345        | Yes           | 20             | Cleanroom services            | Anything else | RM3830      | 09/07/2022     | fmmDetails |
...
#      | Scenario 2.4 | linen     | Service    | Yes         | 12345        | Yes           | 24             | Cleanroom services            | Pest control        | RM3830      | 09/07/2022     | fmmDetails |
      | Scenario 3 | linen and laundry | Service    | Yes         | 12345        | Yes           | 25             | Linen hire with standard wash | Anything else | RM3830      | 09/07/2022     | fmmDetails |
...
#      | Scenario 3.4 | linen     | Service    | Yes         | 12345        | Yes           | 24             | Linen hire with standard wash | Pest control        | RM3830      | 09/07/2022     | fmmDetails |
      | Scenario 4 | laundry services  | Service    | Yes         | 12345        | Yes           | 35             | Standard wash                 | Anything else | RM3830      | 09/07/2022     | fmmDetails |
...
#      | Scenario 4.4 | linen     | Service    | Yes         | 12345        | Yes           | 34             | Standard wash                 | Pest control        | RM3830      | 09/07/2022     | fmmDetails |
  ...
  @linenService7 @Regression @LinenFinalTest
  Scenario Outline: To verify Buyer has provided with different recommendations "<recommendation>" and after answering different set of question as looking for "<lookingFor>", Budget radio as "<budgetRadio>", Contract radio as "<contractRadio>" and enters contract length "<contractLength>" , selects Service area as "<serviceArea>" and Additional facilities as "<addFacilities>" during the journey
    ...
    Examples:
      ...
      | Scenario 4 | linin             | Service    | No          | Yes           | 8              | Standard wash                 | No, I have everything I need | RM6154      | 19/03/2023     | linenDetails | lot1b          | 1    |

    #budget: don't know/not sure, months: <12, addFacilities: answer Other, Security, Grounds maintenance, Catering, Pest Control
  @linenService8 @Regression @LinenFinalTest
  Scenario Outline: To verify Buyer has provided with different recommendations "<recommendation>" and after answering different set of question as looking for "<lookingFor>", Budget radio as "<budgetRadio>", Contract radio as "<contractRadio>" and enters contract length "<contractLength>" , selects Service area as "<serviceArea>" and Additional facilities as "<addFacilities>" during the journey
    Given User logs in to the CCS application for "<ScenarioID>"
    When User enters "<framework>" details
    And User clicks on the "Start now" button
    ...
    Examples:
      ...
      | Scenario 1 | laundry           | Service    | No          | Yes           | 8              | Theatre pack and gowns        | Anything else | RM3830      | 09/07/2022     | fmmDetails |
...
#      | Scenario 1.4 | linen     | Service    | No          | Yes           | 6              | Theatre pack and gowns        | Pest control        | RM3830      | 09/07/2022     | fmmDetails |
      | Scenario 2 | linen             | Service    | No          | Yes           | 5              | Cleanroom services            | Anything else | RM3830      | 09/07/2022     | fmmDetails |
...
#      | Scenario 2.4 | linen     | Service    | No          | Yes           | 4              | Cleanroom services            | Pest control        | RM3830      | 09/07/2022     | fmmDetails |
      | Scenario 3 | laundry           | Service    | No          | Yes           | 5              | Linen hire with standard wash | Anything else | RM3830      | 09/07/2022     | fmmDetails |
...
#      | Scenario 3.4 | linen     | Service    | No          | Yes           | 4              | Linen hire with standard wash | Pest control        | RM3830      | 09/07/2022     | fmmDetails |
      | Scenario 4 | linen and laundry | Service    | No          | Yes           | 5              | Standard wash                 | Anything else | RM3830      | 09/07/2022     | fmmDetails |
...
#      | Scenario 4.4 | linen     | Service    | No          | Yes           | 4              | Standard wash                 | Pest control        | RM3830      | 09/07/2022     | fmmDetails |
   ...
   #budget: don't know/not sure, months: >12, addFacilities: answer No
  @linenService9 @Regression @LinenFinalTest
  Scenario Outline: To verify Buyer has provided with different recommendations "<recommendation>" and after answering different set of question as looking for "<lookingFor>", Budget radio as "<budgetRadio>", Contract radio as "<contractRadio>" and enters contract length "<contractLength>" , selects Service area as "<serviceArea>" and Additional facilities as "<addFacilities>" during the journey
    Given User logs in to the CCS application for "<ScenarioID>"
    When User enters "<framework>" details
    And User clicks on the "Start now" button
    ...
    Examples:
      | ScenarioID | framework         | lookingFor | budgetRadio | contractRadio | contractLength | serviceArea                   | addFacilities                | frameworkId | expirationDate | details      | recommendation | lots |
      | Scenario 1 | linen and laundry | Service    | No          | Yes           | 13             | Theatre pack and gowns        | No, I have everything I need | RM6154      | 19/03/2023     | linenDetails | lot2           | 1    |
      | Scenario 2 | linen and laundry | Service    | No          | Yes           | 14             | Cleanroom services            | No, I have everything I need | RM6154      | 19/03/2023     | linenDetails | lot3           | 1    |
      ...
      | Scenario 4 | linen and laundry | Service    | No          | Yes           | 18             | Standard wash                 | No, I have everything I need | RM6154      | 19/03/2023     | linenDetails | lot1b          | 1    |

   #budget: don't know/not sure, months: >12, addFacilities: answer Other, Security, Grounds maintenance, Catering, Pest Control
  @linenService10 @Regression @LinenFinalTest
  Scenario Outline: To verify Buyer has provided with different recommendations "<recommendation>" and after answering different set of question as looking for "<lookingFor>", Budget radio as "<budgetRadio>", Contract radio as "<contractRadio>" and enters contract length "<contractLength>" , selects Service area as "<serviceArea>" and Additional facilities as "<addFacilities>" during the journey
    Given User logs in to the CCS application for "<ScenarioID>"
    When User enters "<framework>" details
    And User clicks on the "Start now" button
    ...
    Examples:
      | ScenarioID | framework | lookingFor | budgetRadio | contractRadio | contractLength | serviceArea                   | addFacilities | frameworkId | expirationDate | details    |
      | Scenario 1 | linen     | Service    | No          | Yes           | 28             | Theatre pack and gowns        | Anything else | RM3830      | 09/07/2022     | fmmDetails |
...
#      | Scenario 1.4 | linen     | Service    | No          | Yes           | 26             | Theatre pack and gowns        | Pest control        | RM3830      | 09/07/2022     | fmmDetails |
      | Scenario 2 | laundry   | Service    | No          | Yes           | 25             | Cleanroom services            | Anything else | RM3830      | 09/07/2022     | fmmDetails |
...
#      | Scenario 3.4 | linen     | Service    | No          | Yes           | 24             | Linen hire with standard wash | Pest control        | RM3830      | 09/07/2022     | fmmDetails |
      | Scenario 4 | laundry   | Service    | No          | Yes           | 25             | Standard wash                 | Anything else | RM3830      | 09/07/2022     | fmmDetails |
...
#      | Scenario 4.4 | linen     | Service    | No          | Yes           | 24             | Standard wash                 | Pest control        | RM3830      | 09/07/2022     | fmmDetails |
  ...
  @linenService11 @Regression @LinenFinalTest
  Scenario Outline: To verify Buyer has provided with different recommendations "<recommendation>" and after answering different set of question as looking for "<lookingFor>", Budget radio as "<budgetRadio>", Contract radio as "<contractRadio>", selects Service area as "<serviceArea>" and Additional facilities as "<addFacilities>" during the journey
    ...
    Examples:
      ...
      | Scenario 1 | laundry   | Service    | No          | No            | Theatre pack and gowns        | No, I have everything I need | RM6154      | 19/03/2023     | linenDetails | lot2           | 1    |
      | Scenario 2 | laundry   | Service    | No          | No            | Cleanroom services            | No, I have everything I need | RM6154      | 19/03/2023     | linenDetails | lot3           | 1    |
  ...
  @linenService12 @Regression @LinenFinalTest
  Scenario Outline: To verify Buyer has provided with different recommendations "<recommendation>" and after answering different set of question as looking for "<lookingFor>", Budget radio as "<budgetRadio>", Contract radio as "<contractRadio>", selects Service area as "<serviceArea>" and Additional facilities as "<addFacilities>" during the journey
    Given User logs in to the CCS application for "<ScenarioID>"
    When User enters "<framework>" details
    And User clicks on the "Start now" button
    ...
    Examples:
      ...
      | Scenario 1 | linen and laundry | Service    | No          | No            | Theatre pack and gowns        | Anything else | RM3830      | 09/07/2022     | fmmDetails |
...
#      | Scenario 1.4 | linen     | Service    | No          | No            | Theatre pack and gowns        | Pest control        | RM3830      | 09/07/2022     | fmmDetails |
      | Scenario 2 | laundry           | Service    | No          | No            | Cleanroom services            | Anything else | RM3830      | 09/07/2022     | fmmDetails |
...
#      | Scenario 2.4 | linen     | Service    | No          | No            | Cleanroom services            | Pest control        | RM3830      | 09/07/2022     | fmmDetails |
      | Scenario 3 | laundry           | Service    | No          | No            | Linen hire with standard wash | Anything else | RM3830      | 09/07/2022     | fmmDetails |
...
#      | Scenario 4.4 | linen     | Service    | No          | No            | Standard wash                 | Pest control        | RM3830      | 09/07/2022     | fmmDetails |
  ...
  Scenario Outline: To verify Buyer has provided with different recommendations "<recommendation>" and after answering different set of question as looking for "<lookingFor>", Budget radio as "<budgetRadio>", Contract radio as "<contractRadio>", selects Service area as "<serviceArea>" and Additional facilities as "<addFacilities>" during the journey
    ...
    Examples:
      | ScenarioID | framework         | lookingFor | budgetRadio | contractRadio | serviceArea            | addFacilities                                      | frameworkId | expirationDate | details    |
      | Scenario 1 | linen and laundry | Service    | No          | No            | Theatre pack and gowns | Catering_Security                                  | RM3830      | 09/07/2022     | fmmDetails |
      | Scenario 2 | linen and laundry | Service    | No          | No            | Theatre pack and gowns | Catering_Pest control                              | RM3830      | 09/07/2022     | fmmDetails |
