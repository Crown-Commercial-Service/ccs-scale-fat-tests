Feature: GM Journey for Linen framework
  ...
  Scenario Outline: To verify Buyer has provided with different recommendations "<recommendation>" and after answering different set of question as looking for "<lookingFor>", Budget radio as "<budgetRadio>", Contract radio as "<contractRadio>" and enters contract length "<contractLength>" , selects Service area as "<serviceArea>" and Additional facilities as "<addFacilities>" during the journey
    ...
    Examples:
      | ScenarioID | framework | areaSuits | lookingFor | budgetRadio | contractRadio | contractLength | serviceArea                   | addFacilities                | frameworkId | recommendation |
      | Scenario 1 | linen     | Linen     | Service    | No          | Yes           | 3              | Theatre pack and gowns        | No, I have everything I need | RM6154      | lot2           |
      | Scenario 2 | linen     | Linen     | Service    | No          | Yes           | 4              | Cleanroom services            | No, I have everything I need | RM6154      | lot3           |
      | Scenario 3 | linen     | Linen     | Service    | No          | Yes           | 1              | Linen hire with standard wash | No, I have everything I need | RM6154      | lot1a          |
      | Scenario 4 | linen     | Linen     | Service    | No          | Yes           | 8              | Standard wash                 | No, I have everything I need | RM6154      | lot1b          |
  ...
  Scenario Outline: To verify Buyer has provided with different recommendations "<recommendation>" and after answering different set of question as looking for "<lookingFor>", Budget radio as "<budgetRadio>", Contract radio as "<contractRadio>" and enters contract length "<contractLength>" , selects Service area as "<serviceArea>" and Additional facilities as "<addFacilities>" during the journey
    ...
    Examples:
      | ScenarioID | framework | areaSuits | lookingFor | budgetRadio | contractRadio | contractLength | serviceArea                   | addFacilities                | frameworkId | recommendation |
      | Scenario 1 | linen     | Linen     | Service    | No          | Yes           | 13             | Theatre pack and gowns        | No, I have everything I need | RM6154      | lot2           |
      | Scenario 2 | linen     | Linen     | Service    | No          | Yes           | 14             | Cleanroom services            | No, I have everything I need | RM6154      | lot3           |
      | Scenario 3 | linen     | Linen     | Service    | No          | Yes           | 17             | Linen hire with standard wash | No, I have everything I need | RM6154      | lot1a          |
