...
//	    }
    ...
    public void clickActionsLinkOfCustomer(String customerCIN, String linkName, WebDriver webDriver) {
        waitForSeconds(5);
        WebElement linkElement = (new WebDriverWait(webDriver, Duration.ofSeconds(50))).until(ExpectedConditions.elementToBeClickable(By.xpath("//*[contains(text(),'" + customerCIN + "')]/following::div/a[contains(@title,'" + linkName + "')]")));
        linkElement.click();
    }

    public void clickActionsLinkOfUser(String CPID, String linkIcon, WebDriver webDriver) {
        WebElement linkElement = (new WebDriverWait(webDriver, Duration.ofSeconds(50))).until(ExpectedConditions.elementToBeClickable(By.xpath("//*[contains(text(),'" + CPID + "')]/following::div/a[contains(@title,'" + linkIcon + "')]")));
        linkElement.click();
    }
    ...
    public String getAgreementTypeText(WebDriver driver) {
        JavascriptExecutor js = (JavascriptExecutor) driver;
        String xpathExpression = "//strong[normalize-space(text())='Agreement Type:']/following-sibling::text()[1]";
        String result = (String) js.executeScript("var xpath = arguments[0]; " + "var element = document.evaluate(xpath, document, null, 9, null).singleNodeValue;" + "return element ? element.textContent.trim(): '';", xpathExpression);
        return result;
    }
